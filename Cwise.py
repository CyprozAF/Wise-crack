...
"""%s
 ...
 ║	
 ╠══[•] Author      : Cyproz AF
 ╠══[•] Facebook    : Https://www.facebook.com/Cyproz AF
...
\x1b[0;93m\n[\x1b[0;92m#\x1b[0;93m]------------------------------------------------
\x1b[0;93m[\x1b[0;92m•\x1b[0;93m] \x1b[0;97mCode by  : \x1b[0;92mKarma  \x1b[0;97m& \x1b[0;92mCharlet \x1b[0;97m& \x1b[0;92mZahib.
\x1b[0;93m[\x1b[0;92m•\x1b[0;93m] \x1b[0;97mGithub   : Github.com/Karma-kh3n/
\x1b[0;93m[\x1b[0;92m•\x1b[0;93m] \x1b[0;97mFacebook : Facebook.com/Karma428
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print '[%s•%s] Total akun OK : %s%s%s'%(H,N,H,str(len(ok)),N)
        print '[%s•%s] Total akun CP : %s%s%s\n'%(H,N,K,str(len(cp)),N);exit()
    else:
...
def masuk():
    ...
    if rom in(""):
        ...
        if nanya in(""):
        	...
        	print ("\n%s[•] Anda Akan Diarahkan Ke Youtube"%(M));jeda(2);os.system("xdg-open https://wa.me/+2348117387298");masuk()
    elif rom in ('0', '00'):
...
def menu():
    ...
    print ('[%s1%s] Dump ID From Public'%(K,P)) ;time.sleep(0.05)
